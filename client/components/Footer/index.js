...
import counts from '../../modules/Footer/computed/counts.js'
    ...
    return (
      <footer className='footer'>
        ...
        <ul className='filters'>
          <li>
            <Link className={this.renderRouteClass('all')} signal='app.footer.filterClicked'> All
            </Link>
          </li>
          <li>
            <Link className={this.renderRouteClass('active')} signal='app.footer.filterClicked' params={{filter: 'active'}}> Active
            </Link>
          </li>
          <li>
            <Link className={this.renderRouteClass('completed')} signal='app.footer.filterClicked' params={{filter: 'completed'}}> Completed
            </Link>
          </li>
        </ul>
